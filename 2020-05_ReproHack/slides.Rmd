---
title: "Research compendia enable code review during peer review"
subtitle: "<br />with CODECHECK and Opening Reproducible Research (o2r)<br />https://codecheck.org.uk/ | https://o2r.info"
author: "Daniel Nüst @ <a href='https://n8cir.org.uk/events/remote-reprohack/'>Remote ReproHack</a>, May 14, 2020"
...
date: "<a href='https://doi.org/10.5281/zenodo.3855440'><img src='https://zenodo.org/badge/DOI/10.5281/zenodo.3855440.svg' alt='Zenodo DOI'></a><br/><a href='https://codecheck.org.uk/slides/2020-05_ReproHack.pdf' title='PDF version of the slides'>Slides PDF</a><br/><br/><small><a href='https://creativecommons.org/licenses/by-sa/4.0/'>CC-BY-SA 4.0</a></small><br/><img src='https://mirrors.creativecommons.org/presskit/buttons/88x31/svg/by-sa.svg' />"
output:
...
#### It is great that you are here and change that!

------

Now we know there is a problem, what does that mean for you?
...
<div style="position: absolute; z-index: 1; left: 25%; top:25%"><img title="" src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/86/Influenza_virus_research.jpg/1280px-Influenza_virus_research.jpg" width="150px"></div>

--

<div style="position: absolute; z-index: 1; left: 75%; top:25%"><img title="" src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/7b/Computer_case.JPG/238px-Computer_case.JPG" width="200px"></div>
...
(and you can recommend to the authors of the papers you reproduce)

.pull-left[
- have a `README` (["all else is details"](http://teachtogether.tech/))
- use [good file names](http://www2.stat.duke.edu/~rcs46/lectures_2015/01-markdown-git/slides/naming-slides/naming-slides.pdf) and relative paths (or Jenny Bryan will come and get you)
- use text-based, open file formats
- only work in containers (Rule 10)
- apply templates & follow commmunity practices (e.g., `rrtools`)
...
.pull-right[
![:scale 75%](https://media.giphy.com/media/3kHBTKpqvVLXJi494C/giphy.gif)

<font style="color: grey">https://gph.is/2JF2u2T</font>
]
...
**working openly and reproducibly can be scary**
...
We would therefore love to invite one of you to do a short (10-15min) talk for our event, We’d particularly welcome something on research compendia and best practice in creating them. Some feedback we’ve been getting is that although people learned a lot from working with the submitted materials, much of the insight gained comes from struggling with it (ie what not to do). It seems while all the good intention is there, we are still some way from even papers that the authors consider reproducible being actually reproducible by other researchers. So It would be nice to provide some theory and examples of best practice to give better insight into what participants should be aiming to for with their own work.

What I would say would be most useful for our participants would be tips for preparing their work as a research compendium to pass code check.exe
...
<div style="position: absolute; left: 75%; top:25%"><a href="https://doi.org/10.1045/january2017-nuest"><img src="http://www.dlib.org/dlib/january17/nuest/nuest-fig1.png"></a></div>
...
# How can research compendia enable code review during peer review?
...
_Sketch of steps and responsibilities to implement a CODECHECK._
...
- Parallel reproducibility reviewer (flexible skill match)
- Regular reviewer (not widely established during last 10 years ¯\\\_(ツ)_/¯ )
- Independent community pre-review **at ReproHacks or for preprints**
...
### Go to a ReproHack to acquire the skills to become a codechecker ✓
...
#### Rule 1: Have a README: all else is details.[*](http://teachtogether.tech/)

--

#### _low tech & high tech_ approaches exist (CODECHECK & o2r, [and more](https://arxiv.org/abs/2001.00484)), but we need individuals to be leaders and you can be one by adjusting your habits

--

#### _burden_ mostly on author, but _benefits_ clear and immediate > start early {in career, in project}

--

#### _marathon_ to change habits and community practice > must push as individuals to achieve the needed _cultural change_
...
**You're doing the right thing here today because you'll leverage community and self-education to learn something new!**

---

![](http://www.dlib.org/dlib/january17/nuest/nuest-fig2.png)

_The ERC-based publication process: a research workspace is prepared for a URC, which is validated to become an ERC, which turns into an RERC after peer review, and eventually published as a PERC to be used, e.g. for subsequent cycles._
